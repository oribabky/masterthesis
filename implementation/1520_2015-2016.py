...
dataset = pandas.read_excel(open('../data/stations_e6/mätvärden total.xlsx','rb'), sheet_name='dsc111_noerr', skiprows=[0], header=1, 
...
# class distribution
print(dataset.groupby('Ytstatus-DSC111').size())
